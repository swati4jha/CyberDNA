(function () {
    ...
    angular
        .module('app')
        .controller('AccountsController', HomeController);
    ...
    function HomeController(UserService, $rootScope, $scope, $location, $http, $timeout, $interval, uiGridConstants, uiGridGroupingConstants) {
        ...
        $scope.list5 = [
          { 'title': 'Home', 'drag': true },
          { 'title': 'Transfer', 'drag': true },
          { 'title': 'Deposit', 'drag': true },
          { 'title': 'My Accounts', 'drag': true },
          { 'title': 'Bill Pay', 'drag': true },
        ...
        $scope.listItems = [{
          ...
          $scope.gridOptions = {
        		    ...
        		    columnDefs: [
        		    	{ name:'S No', width:50 },
          		      { name:'Account Number', width:200, enableCellEdit: false },
          		    	  { name:'Transaction Date', width:150 },
          		    	  { name:'Transaction Remark', width:300 },
          		    	  { name:'CR/DR', width:100 },
          		    	  { name:'Amount', width:150, aggregationType: uiGridConstants.aggregationTypes.avg, 
